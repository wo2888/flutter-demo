...
class DemoPageState extends State<DemoPage3> {
  // String url =
  ...
  List<Widget> buildGridTileList(int number) {
    ...
    widgetList.add(HorizontalPatternForwardHatchBarChart.withSampleData());
    widgetList.add(ScatterPlotComboLineChart.withSampleData());
