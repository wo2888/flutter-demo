...
import '../pages/demo10.dart';
import '../pages/demo11.dart';
import '../pages/demo7.dart';
import '../pages/demo8.dart';
import '../pages/demo9.dart';
...
class DemoPageState extends State<DemoPage4> {
  // String url =
  ...
  List<Widget> buildGridTileList(int number) {
    ...
    widgetList.add(OrdinalComboBarLineChart.withSampleData());
    widgetList.add(SelectionCallbackExample.withSampleData());
