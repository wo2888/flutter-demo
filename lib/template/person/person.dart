...
class QMPersonCenter extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      home: new _QMPersonCenter(bgImage: bgImage,desc:desc,user:user),
    );
  }
}
...
class _QMPersonCenter extends StatefulWidget {
  ...
  final QMPerson user;
  final QMPersonDescription desc;
  _QMPersonCenter({Key key,this.bgImage,this.desc,this.user}) : super(key: key);
...
class _MainPageState extends State<_QMPersonCenter> {
  ...
  void initState() {
    super.initState();
    listModel = new ListModel(_listKey, widget.user.list ?? tasks);
  }
...
class QMPersonItem {
  ...
  QMPersonItem({this.name, this.category, this.time, this.color, this.completed});
}
